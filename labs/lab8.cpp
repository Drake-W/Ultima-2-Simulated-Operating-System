...
int main(){
	...
	cout << "Hex:					" << std::hex << (clearChar | 0x0C ) << endl;
	...
	cout << char_to_binary(clearChar) << " ^ 0000 1100 ^ 0000 1100= " << char_to_binary(clearChar ^ 0x0C ^ 0x0c) << endl;

	cout << "===================== Complement OPERATION ============================" << endl;

	clearChar = 0x09;
	cout << "~0000 1001 = " << char_to_binary(~clearChar) << endl;
